...
public class OutcomeCurrMgmtApplication {
        ...
        CommandLineRunner commandLineRunner(
                ...
                // .apcNameSpa("Plan de estudios de ingeniería de sistemas para los años
                // 2017-2021")
                // .build();
                //
                ...
                // .soLongNameSpa("SO1 - Solución de problemas: Identificar, formular y resolver
                // problemas complejos de ingeniería aplicando pensamiento crítico y principios
                // de las ciencias, las matemáticas, la ingeniería y, en particular, de las
                // Ciencias de la Computación y de la Ingeniería de Software.")
                ...
                // .soLongNameSpa("SO2 – Diseño de Ingeniería: Diseñar soluciones y procesos
                // basados en software que satisfagan necesidades específicas y generen valor a
                // sus usuarios, considerando la salud pública, la seguridad y el bienestar de
                // las personas, así como factores globales, culturales, sociales, ambientales y
                // económicos.")
                ...
                // .piLongNameEng("1-PI1 Problem identification and formulation: to identify a
                // complex problem and formulate it, by applying principles of engineering (the
                // engineering method).")
                // .piLongNameSpa("SO1-PI1 Identificación y formulación de problemas:
                // Identificar un problema complejo y formularlo, aplicando principios de
                // ingeniería y el método de ingeniería.")
                // .piOrdinalNumber(1)
                // .build();
                //
                ...
                // .piLongNameEng("1-PI2 Problem solution (engineering/science): to solve
                // complex problems by proposing a strategy compatible with the formulation and
                // by applying principles of engineering or science.")
                // .piLongNameSpa("SO1-PI2 Solución de problema (ingeniería/ciencias): Resolver
                // problemas complejos proponiendo una estrategia compatible con la formulación
                // y aplicando principios de ingeniería o ciencias.")
                // .piOrdinalNumber(2)
                // .build();
                //
                ...
                // .piLongNameEng("1-PI3 Problem solution (mathematics): to solve complex
                // problems by proposing strategies compatible with their formulation and by
                // applying mathematics.")
                // .piLongNameSpa("SO1-PI3 Solución del problema (matemáticas): Resolver
                // problemas complejos proponiendo estrategias compatibles con su formulación y
                ...
                // .piLongNameEng("2-PI1 Detailed Design: To produce detailed design
                // specifications that meet functional requirements, correctly using the
                // corresponding tools and notations.")
                // .piLongNameSpa("SO2-PI1 Diseño detallado: Producir especificaciones de diseño
                // detalladas que cumplan con los requerimientos funcionales, utilizando
                // correctamente las herramientas y notaciones correspondientes.")
                // .piOrdinalNumber(1)
                // .build();
                //
                ...
                // .piLongNameEng("2-PI2 High Level Design: To produce architectural
                // specifications, by correctly using the corresponding tools and notations,
                // that meet functional and non-functional requirements, as well as consider
                // public health, safety, welfare, as well as global, cultural, social,
                // environmental, and economic factors, when relevant.")
                // .piLongNameSpa("SO2-PI2 Diseño de alto nivel: Producir especificaciones
                // arquitectónicas mediante el uso correcto de las herramientas y notaciones
                // correspondientes, que cumplan con los requerimientos funcionales y no
                // funcionales, además de considerar la salud pública, la seguridad, el
                // bienestar, así como los factores globales, culturales, sociales, ambientales
                // y económicos, cuando sea relevante.")
                // .piOrdinalNumber(2)
                // .build();
                //
                ...
                // .piLongNameEng("2-PI3 Evaluation of solution design: To evaluate
                // architectural specifications with respect to specified needs and most
                // significant concerns (among non-functional requirements and aspects such as
                // public health, safety, welfare, as well as global, cultural, social,
                // environmental, and economic factors).")
                // .piLongNameSpa("SO2-PI3 Evaluación de diseño de soluciones: Evaluar las
                // especificaciones arquitectónicas con respecto a las necesidades específicas y
                // las preocupaciones más importantes (entre los requerimientos no funcionales y
                // aspectos como la salud pública, la seguridad, el bienestar, así como los
                ...
                return args -> {
                        ...
                        // acadProgCurriculumRepository.save(acadProgCurriculum);
                        //
                        ...
                        // perfIndicatorRepository.save(perfIndicator2SO1);
                        ...
                        // perfIndicatorRepository.save(perfIndicator1SO2);
                        // PerfIndicator perfIndicator2SO2Saved =
                        // perfIndicatorRepository.save(perfIndicator2SO2);
                        ...
                        // assessmentTypeRepository.save(formativeAssessmentType);
                        ...
                        // .perfIndicator(perfIndicator2SO1Saved)
                        // .acadProgCurriculum(acadProgCurriculumSaved)
                        // .cmAcceptedDate(new Date(System.currentTimeMillis() - 1000L * 60L * 60L *
                        // 24L))
                        // .build();
                        //
