...
public interface AuthFacultyController {
        ...
        @ApiResponses({
                        ...
                        @ApiResponse(responseCode = "409", content = {
                                        @Content(schema = @Schema($comment = DUPLICATED_NAME_IN_SPA + " OR "
                                                        + DUPLICATED_NAME_IN_ENG)) }),
                        @ApiResponse(responseCode = "403", content = {
                                        @Content(schema = @Schema($comment = "Required permissions for this operation: "
                                                        + ROLE_ADMIN_FACULTIES_ANY)) }) })
        FacultyOutDTO createFaculty(@Valid @RequestBody FacultyInDTO facultyInDTO);
        ...
        @PreAuthorize("hasAnyRole('" + ROLE_ADMIN_FACULTIES_ANY + "','" + ROLE_QUERY_FACULTIES_ANY + "','"
                        + ROLE_ADMIN_FACULTIES_OWN + "','" + ROLE_QUERY_FACULTIES_OWN + "')")
        ...
        @ApiResponses({
                        ...
                        @ApiResponse(responseCode = "403", content = {
                                        @Content(schema = @Schema($comment = "Required permissions for this operation: "
                                                        + ROLE_ADMIN_FACULTIES_ANY + " OR " + ROLE_QUERY_FACULTIES_ANY
                                                        + " OR " + ROLE_ADMIN_FACULTIES_OWN + " OR "
                                                        + ROLE_QUERY_FACULTIES_OWN)) }) })
        @ApiResponse(responseCode = "404", content = {
                        @Content(schema = @Schema($comment = "Faculty not found")) })
        ...
        @ApiResponses({
                        ...
                        @ApiResponse(responseCode = "409", content = {
                                        @Content(schema = @Schema($comment = DUPLICATED_NAME_IN_SPA + " OR "
                                                        + DUPLICATED_NAME_IN_ENG)) }) })
        FacultyOutDTO updateFaculty(@PathVariable("facultyId") long facultyId,
